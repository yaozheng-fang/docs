...
| :--- | :--- | :--- | :--- | :--- |
| `local` | No (memory only) | None | Local debugging, ephemeral sessions | [In-memory](/en/veadk/1.0.4/components/session/local) |
| `sqlite` | Yes (local file) | None | Single-node persistence | [SQLite](/en/veadk/1.0.4/components/session/sqlite) |
| `mysql` | Yes | MySQL | Distributed persistence | [MySQL](/en/veadk/1.0.4/components/session/mysql) |
| `postgresql` | Yes | PostgreSQL | Distributed persistence | [PostgreSQL](/en/veadk/1.0.4/components/session/postgresql) |
