...
| `milvus` | Milvus collection | Milvus + `extensions` + embedding | Self-hosted or managed Milvus | [Milvus](/en/veadk/components/knowledge/milvus) |
...
| `openviking` | OpenViking resource tree | OpenViking service | Server-side resource processing and retrieval | [OpenViking](/en/veadk/components/knowledge/openviking) |
