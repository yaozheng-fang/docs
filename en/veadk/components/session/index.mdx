---
title: "Overview"
description: "Short-term memory holds session-level context so an agent remembers what was said across turns, with support for multiple persistence backends."
---
...
| :--- | :--- | :--- | :--- | :--- |
| `local` | No (memory only) | None | Local debugging, ephemeral sessions | [In-memory](/en/veadk/components/session/local) |
| `sqlite` | Yes (local file) | None | Single-node persistence | [SQLite](/en/veadk/components/session/sqlite) |
| `mysql` | Yes | MySQL | Distributed persistence | [MySQL](/en/veadk/components/session/mysql) |
| `postgresql` | Yes | PostgreSQL | Distributed persistence | [PostgreSQL](/en/veadk/components/session/postgresql) |
