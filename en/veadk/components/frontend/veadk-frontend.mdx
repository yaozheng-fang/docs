...
- **Create agents**: build an agent from scratch in the UI — conversational, custom, template, and workflow modes — producing a runnable VeADK project (`agent.py`, `requirements.txt`, and so on) that you can preview, edit, and download.
