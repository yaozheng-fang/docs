...
Runtime logs use Python's standard `logging` package. See [Application logging](/en/veadk/components/observability/logging) for levels, formatting, and trace correlation.
