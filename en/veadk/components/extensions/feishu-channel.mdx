...
<Note>
This page treats Feishu as an **inbound message channel**: messages from Feishu users trigger the agent. If instead you want the agent to **call Feishu capabilities** (send messages, process cloud docs, manage calendars), see `lark_tools` in [Built-in MCP tools](/en/veadk/components/tools/builtin-mcp).
</Note>
