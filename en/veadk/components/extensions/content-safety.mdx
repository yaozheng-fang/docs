---
title: "Safeguards"
description: "Callback-based content-safety guardrail that uses the Volcengine LLM Application Firewall to review content at each stage and block unsafe input and output."
---
