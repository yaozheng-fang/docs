...
tag: "System tool"
description: "Auto-mounted when you pass long-term memory to the agent; retrieves long-term memory at runtime."
---
...
For long-term memory backends and configuration, see the [long-term memory docs](/en/veadk/components/memory).
