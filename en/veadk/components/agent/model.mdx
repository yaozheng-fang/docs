---
title: "Model"
description: "Configure an agent's reasoning model"
---

By default an agent uses the globally configured model — the one set via
environment variables or `config.yaml` (see the [Quickstart](/en/veadk/get-started/quickstart)).
...
```python
agent = Agent(
    model_name=["doubao-seed-1-6-250615", "doubao-seed-1-8-251228"],
)
```
