---
title: "Code-free agents"
description: "Initialize, configure, and deploy a code-free harness.yaml agent."
---
...
Create a harness directory (`harness.yaml` + `.env.example`) for a code-free agent.
