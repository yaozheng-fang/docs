---
title: "运行评测实验"
en_link: "/productions/agentkit-cli/archives/0.50.8/en/commands/eval/run"
---
...
提交成功后返回实验 ID，可用 [`eval experiment get`](/productions/agentkit-cli/archives/0.50.8/zh/commands/eval/experiment) 跟踪：
