---
title: "使用沙箱"
en_link: "/productions/agentkit-cli/archives/0.50.8/en/commands/sandbox"
---
...
| `tool-type` | `CodeEnv` \| `SkillEnv` \| `DevEnv` \| `ArkClawEnv` \| `HermesEnv` \| `Private` | `CodeEnv` | 默认沙箱工具类型。 |
...
| 标志/参数 | 说明 | 默认值 |
| --- | --- | --- |
| `--tool-type <type>` | 工具类型：`CodeEnv`、`SkillEnv`、`DevEnv`、`ArkClawEnv`、`HermesEnv`、`Private`。 | 配置值或 `CodeEnv` |
