---
title: "Use sandboxes"
zh_link: "/productions/agentkit-cli/archives/0.50.9/zh/commands/sandbox"
---
...
| `tool-type` | `CodeEnv` \| `SkillEnv` \| `DevEnv` \| `ArkClawEnv` \| `HermesEnv` \| `Private` | `CodeEnv` | Default sandbox tool type. |
...
| Flag / Argument | Description | Default |
| --- | --- | --- |
| `--tool-type <type>` | Tool type: `CodeEnv`, `SkillEnv`, `DevEnv`, `ArkClawEnv`, `HermesEnv`, or `Private`. | Config value or `CodeEnv` |
