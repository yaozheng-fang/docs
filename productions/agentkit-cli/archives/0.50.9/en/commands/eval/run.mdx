...
zh_link: "/productions/agentkit-cli/archives/0.50.9/zh/commands/eval/run"
---
...
Once submitted successfully it returns an experiment id, which you can track with [`eval experiment get`](/productions/agentkit-cli/archives/0.50.9/en/commands/eval/experiment):
