...
zh_link: "/productions/agentkit-cli/archives/0.51.1/zh/workflows/feishu"
---
...
- **Runtime auth**: on the Feishu path the runtime uses `key_auth` (the proxy holds the API key). For web login with per-user identity forwarding, see [Deploy a frontend with SSO login](/productions/agentkit-cli/archives/0.51.1/en/workflows/frontend-sso).
