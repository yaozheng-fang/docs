...
IM channel and frontend release settings still live in `.agentkit/agentkit.yaml`; see [agentkit.yaml](/productions/agentkit-cli/archives/0.51.1/en/agentkit-yaml) for field details.
