...
zh_link: "/productions/agentkit-cli/archives/0.52.0/zh/commands/eval/experiment"
---

The `eval experiment` command group (alias `exp`) is used to view experiments submitted by [`eval run`](/productions/agentkit-cli/preview/en/commands/eval/run): list experiments, view an experiment's status and aggregate scores, and fetch per-case results.
