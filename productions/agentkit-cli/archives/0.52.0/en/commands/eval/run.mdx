...
zh_link: "/productions/agentkit-cli/archives/0.52.0/zh/commands/eval/run"
---
...
Once submitted successfully it returns an experiment id, which you can track with [`eval experiment get`](/productions/agentkit-cli/preview/en/commands/eval/experiment):
