...
zh_link: "/productions/agentkit-cli/archives/0.50.5/zh/commands/eval/run"
---
...
Once submitted successfully it returns an experiment id, which you can track with [`eval experiment get`](/productions/agentkit-cli/archives/0.50.5/en/commands/eval/experiment):
