---
title: "agentkit.yaml"
zh_link: "/productions/agentkit-cli/archives/0.52.6/zh/agentkit-yaml"
---
...
| `harness_sidecar.model_proxy.enabled` | boolean | `true` | Whether to enable the model proxy. Managed APIG runtime requires this to stay `true`. |
| `harness_sidecar.model_proxy.host` | string | `0.0.0.0` | Model proxy bind host. Managed APIG runtime requires an externally reachable host. |
| `harness_sidecar.model_proxy.port` | integer | `18787` | Model proxy bind port. |
...
| `harness_sidecar.model_proxy.prefer_configured_upstream_api_key` | boolean | `true` | Managed APIG runtime requires the configured upstream API key. |
