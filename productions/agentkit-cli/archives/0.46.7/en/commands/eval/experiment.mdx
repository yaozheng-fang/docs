...
zh_link: "/productions/agentkit-cli/archives/0.46.7/zh/commands/eval/experiment"
---

The `eval experiment` command group (alias `exp`) is used to view experiments submitted by [`eval run`](/productions/agentkit-cli/archives/0.46.7/en/commands/eval/run): list experiments, view an experiment's status and aggregate scores, and fetch per-case results.
