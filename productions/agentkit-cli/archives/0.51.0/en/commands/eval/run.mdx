...
zh_link: "/productions/agentkit-cli/archives/0.51.0/zh/commands/eval/run"
---
...
Once submitted successfully it returns an experiment id, which you can track with [`eval experiment get`](/productions/agentkit-cli/archives/0.51.0/en/commands/eval/experiment):
