...
zh_link: "/productions/agentkit-cli/archives/0.50.3/zh/commands/eval/run"
---
...
Once submitted successfully it returns an experiment id, which you can track with [`eval experiment get`](/productions/agentkit-cli/archives/0.50.3/en/commands/eval/experiment):
