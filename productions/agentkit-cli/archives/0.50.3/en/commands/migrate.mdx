...
zh_link: "/productions/agentkit-cli/archives/0.50.3/zh/commands/migrate"
---
...
| `--codex-model-provider <provider>` | Model provider used by the remote migration sandbox | `model_square` |
