...
zh_link: "/productions/agentkit-cli/archives/0.50.3/zh/workflows/frontend-sso"
---
...
When you only need a bot channel and no web login, use [Deploy as a Feishu bot](/productions/agentkit-cli/archives/0.50.3/en/workflows/feishu) instead.
