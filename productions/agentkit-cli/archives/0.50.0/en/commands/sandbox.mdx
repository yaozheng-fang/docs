---
title: "Use sandboxes"
zh_link: "/productions/agentkit-cli/archives/0.50.0/zh/commands/sandbox"
---
...
| `tool-type` | `CodeEnv` \| `SkillEnv` \| `Private` | `CodeEnv` | Default sandbox tool type. |
...
| Flag / Argument | Description | Default |
| --- | --- | --- |
| `--tool-type <type>` | Tool type: `CodeEnv`, `SkillEnv`, or `Private`. | Config value or `CodeEnv` |
