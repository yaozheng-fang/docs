---
title: "查看实验与结果"
en_link: "/productions/agentkit-cli/archives/0.50.0/en/commands/eval/experiment"
---

`eval experiment` 命令组（别名 `exp`）用于查看由 [`eval run`](/productions/agentkit-cli/archives/0.50.0/zh/commands/eval/run) 提交的实验：列出实验、查看某个实验的状态与汇总分数、拉取逐条结果。
