---
title: "A2UI"
en_link: "/productions/veadk/archives/1.0.5/en/components/frontend/a2ui"
---
...
A2UI 界面由前端渲染。用 [VeADK Frontend](/productions/veadk/archives/1.0.5/zh/components/frontend/veadk-frontend) 启动界面，与智能体对话即可看到返回的卡片等组件。
...
把自定义组件清单传给智能体的 `a2ui_catalog` 即可启用。前端渲染器的接入方式见 [VeADK Frontend · 添加企业自定义组件](/productions/veadk/archives/1.0.5/zh/components/frontend/veadk-frontend#添加企业自定义组件)。
