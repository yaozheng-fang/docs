---
title: "运行时"
en_link: "/productions/veadk/archives/1.0.5/en/components/agent/runtime"
---
...
- `tools` 中的[函数工具](/productions/veadk/archives/1.0.5/zh/components/tools/custom-function)会作为可调用工具提供给模型；
- `tools` 中的 [MCPToolset](/productions/veadk/archives/1.0.5/zh/components/tools/custom-mcp)会完成工具发现与调用；
- 通过 `SkillToolset` 或 VeADK 旧入口加载的[技能](/productions/veadk/archives/1.0.5/zh/components/agent/skills)会交由 Codex 的技能机制使用。
