...
zh_link: "/productions/veadk/archives/1.0.5/zh/components/tools/load-memory"
---
...
For long-term memory backends and configuration, see the [long-term memory docs](/productions/veadk/archives/1.0.5/en/components/memory).
