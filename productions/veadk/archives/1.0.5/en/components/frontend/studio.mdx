...
zh_link: "/productions/veadk/archives/1.0.5/zh/components/frontend/studio"
---
...
When the default role is used, deployment adds the system policies required for model, logging, tracing, knowledge, memory, and identity resources. A role supplied explicitly with `--iam-role` is not modified and must already have the complete permission set.
