---
title: "Feishu"
zh_link: "/productions/veadk/archives/1.0.5/zh/components/extensions/feishu-channel"
---
...
<Note>
This page treats Feishu as an **inbound message channel**: messages from Feishu users trigger the agent. To let the agent call Feishu capabilities, see [Feishu tools](/productions/veadk/archives/1.0.5/en/components/tools/lark).
</Note>
