...
zh_link: "/productions/veadk/archives/1.0.4/zh/components/memory"
---
...
| :--- | :--- | :--- | :--- |
| `backend` | `"local" \| "opensearch" \| "redis" \| "viking" \| "mem0" \| "openviking"` | `"opensearch"` | Selects the backend. `viking_mem` is deprecated and maps to `viking`. |
