---
title: "Runtime"
zh_link: "/productions/veadk/archives/1.0.4/zh/components/agent/runtime"
---
...
- [function tools](/productions/veadk/archives/1.0.4/en/components/tools/custom-function) in `tools` are exposed as callable tools to the model;
- an [MCPToolset](/productions/veadk/archives/1.0.4/en/components/tools/custom-mcp) in `tools` supports tool discovery and invocation;
- [skills](/productions/veadk/archives/1.0.4/en/components/agent/skills) loaded through `SkillToolset` or VeADK's legacy entry are made available through the Codex skill mechanism.
