---
title: "Studio 智能体工作台"
en_link: "/productions/veadk/archives/1.0.4/en/components/frontend/studio"
---

VeADK Studio 是面向智能体创建与管理的工作台。它使用与 VeADK Frontend 相同的服务，但隐藏对话、搜索、历史会话和技能中心等使用侧功能，启动后直接进入「添加智能体」页面。
...
1. 在「添加智能体」中选择智能生成、自定义或模板；工作流入口暂不可用。
