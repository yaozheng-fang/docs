---
title: "长期记忆"
en_link: "/productions/veadk/archives/1.0.3/en/components/memory"
---
...
| 参数 | 类型 | 默认值 | 说明 |
| :--- | :--- | :--- | :--- |
| `backend` | `"local" \| "opensearch" \| "redis" \| "viking" \| "mem0" \| "openviking"` | `"opensearch"` | 选择后端。`viking_mem` 已废弃，自动转为 `viking`。 |
