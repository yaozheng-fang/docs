---
title: "使用 SQLite 存储"
en_link: "/productions/veadk/archives/1.0.9/en/components/session/sqlite"
---
...
需要分布式持久化？请改用 [MySQL](/productions/veadk/archives/1.0.9/zh/components/session/mysql) 或 [PostgreSQL](/productions/veadk/archives/1.0.9/zh/components/session/postgresql)。
