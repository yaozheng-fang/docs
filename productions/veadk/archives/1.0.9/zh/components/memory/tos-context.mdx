...
en_link: "/productions/veadk/archives/1.0.9/en/components/memory/tos-context"
---
...
下面的示例先保存一个会话，再从新会话中检索同一用户的长期记忆。运行前还需按[模型配置](/productions/veadk/archives/1.0.9/zh/components/agent/model)准备模型凭证。
