---
title: "飞书"
en_link: "/productions/veadk/archives/1.0.9/en/components/extensions/feishu-channel"
---
...
<Note>
本页是把飞书**作为入站消息渠道**：飞书用户发来的消息会触发智能体运行。若需让智能体主动调用飞书能力，请参见[飞书工具](/productions/veadk/archives/1.0.9/zh/components/tools/lark)。
</Note>
