...
zh_link: "/productions/veadk/archives/1.0.1/zh/components/knowledge"
---
...
| :--- | :--- | :--- | :--- |
| `backend` | `"local" \| "opensearch" \| "redis" \| "tos_vector" \| "viking" \| "context_search"` | `"local"` | Selects the backend. |
