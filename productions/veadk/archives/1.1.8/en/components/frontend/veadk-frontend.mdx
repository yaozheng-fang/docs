...
zh_link: "/productions/veadk/archives/1.1.8/zh/components/frontend/veadk-frontend"
---
...
- **Share conversation as image**: export all inputs and outputs up to an assistant reply as a PNG image, with download or copy-to-clipboard support. This applies to both the `veadk frontend` and `veadk studio` conversation pages.
