...
zh_link: "/productions/veadk/archives/1.1.12/zh/components/memory/openviking"
---
...
| `memory_policy` | `dict \| None` | `None` | OpenViking memory extraction policy. When unset, no policy is sent to OpenViking and the service applies its official default. |
