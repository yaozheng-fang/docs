---
title: "概览"
en_link: "/productions/veadk/archives/1.0.7/en/components/session"
---
...
| :--- | :--- | :--- | :--- | :--- |
| `local` | 否（仅内存） | 无 | 本地调试、临时会话 | [本地内存](/productions/veadk/archives/1.0.7/zh/components/session/local) |
| `sqlite` | 是（本地文件） | 无 | 单机持久化 | [SQLite](/productions/veadk/archives/1.0.7/zh/components/session/sqlite) |
| `mysql` | 是 | MySQL | 分布式持久化 | [MySQL](/productions/veadk/archives/1.0.7/zh/components/session/mysql) |
| `postgresql` | 是 | PostgreSQL | 分布式持久化 | [PostgreSQL](/productions/veadk/archives/1.0.7/zh/components/session/postgresql) |
