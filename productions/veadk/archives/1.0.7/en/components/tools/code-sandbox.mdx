...
zh_link: "/productions/veadk/archives/1.0.7/zh/components/tools/code-sandbox"
---
...
| Tool | Description |
| :--- | :--- |
| `run_code` | Execute arbitrary code or shell commands for computation, data processing, dependency installation, and similar tasks |
...
| :--- | :--- | :--- | :--- |
| `code` | `str` | — | Code or shell command to execute. |
| `language` | `str` | — | Use `python3` for Python code, or `bash` / `shell` for shell commands. |
| `tool_context` | `ToolContext` | — | Tool runtime context injected by VeADK. |
...
| `max_output_length` | `int` | `30000` | Maximum shell output length. |
