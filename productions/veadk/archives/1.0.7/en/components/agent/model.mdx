---
title: "Model"
zh_link: "/productions/veadk/archives/1.0.7/zh/components/agent/model"
---

By default an agent uses the globally configured model — the one set via
environment variables or `config.yaml` (see the [Quickstart](/productions/veadk/archives/1.0.7/en/get-started/quickstart)).
