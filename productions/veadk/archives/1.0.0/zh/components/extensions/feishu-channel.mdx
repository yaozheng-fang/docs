---
title: "飞书"
en_link: "/productions/veadk/archives/1.0.0/en/components/extensions/feishu-channel"
---
...
<Note>
本页是把飞书**作为入站消息渠道**：飞书用户发来的消息会触发智能体运行。若需反过来——让智能体**调用飞书能力**（发消息、处理云文档、管理日历），请参见[飞书 Lark MCP](/productions/veadk/archives/1.0.0/zh/components/tools/lark)。
</Note>
