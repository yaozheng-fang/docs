---
title: "Runtime"
zh_link: "/productions/veadk/archives/1.0.0/zh/components/agent/runtime"
---
...
<Warning>
  The Codex runtime may execute commands and access files according to the Codex SDK policy. Run trusted tasks in an isolated environment and restrict the credentials and data available to the process. VeADK 1.0.0 does not override the SDK defaults for sandboxing, network access, or review.
</Warning>
