...
zh_link: "/productions/veadk/archives/1.0.2/zh/components/tools/vesearch"
---
...
Requests to the web-aware Q&A service time out after 30 seconds, preventing an
unresponsive service from blocking agent execution indefinitely.
