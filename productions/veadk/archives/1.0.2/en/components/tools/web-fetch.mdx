---
title: "Web fetch"
zh_link: "/productions/veadk/archives/1.0.2/zh/components/tools/web-fetch"
---
...
- **TLS verification**: HTTPS requests verify certificates; an invalid or unverifiable certificate causes the request to fail with an error.
