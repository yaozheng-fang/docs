...
zh_link: "/productions/veadk/archives/1.0.2/zh/components/security/content-safety"
---
...
Content-safety debug logs do not record API-key values. In production, continue to provide credentials through environment variables or a secret manager and restrict access to logs.
