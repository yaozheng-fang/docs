---
title: "Feishu"
zh_link: "/productions/veadk/archives/1.0.2/zh/components/extensions/feishu-channel"
---
...
<Note>
This page treats Feishu as an **inbound message channel**: messages from Feishu users trigger the agent. If instead you want the agent to **call Feishu capabilities** (send messages, process cloud docs, manage calendars), see `lark_tools` in [Feishu Lark MCP](/productions/veadk/archives/1.0.2/en/components/tools/lark).
</Note>
