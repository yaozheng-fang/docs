---
title: "飞书"
en_link: "/productions/veadk/archives/1.0.2/en/components/extensions/feishu-channel"
---
...
<Note>
本页是把飞书**作为入站消息渠道**：飞书用户发来的消息会触发智能体运行。若需反过来——让智能体**调用飞书能力**（发消息、处理云文档、管理日历），请参阅[飞书 Lark MCP](/productions/veadk/archives/1.0.2/zh/components/tools/lark)中的 `lark_tools`。
</Note>
