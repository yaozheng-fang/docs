...
<Note>
  The Hermes Dashboard auto-start and proxy apply only in VeStack deployment mode. In non-VeStack (public cloud) deployments, the Hermes Dashboard is not started or proxied.
</Note>
