---
title: "概览"
description: "短期记忆保存会话级上下文，让智能体在多轮交互中记住之前说过的话，并支持多种持久化后端。"
---
...
| :--- | :--- | :--- | :--- | :--- |
| `local` | 否（仅内存） | 无 | 本地调试、临时会话 | [本地内存](/zh/veadk/components/session/local) |
| `sqlite` | 是（本地文件） | 无 | 单机持久化 | [SQLite](/zh/veadk/components/session/sqlite) |
| `mysql` | 是 | MySQL | 分布式持久化 | [MySQL](/zh/veadk/components/session/mysql) |
| `postgresql` | 是 | PostgreSQL | 分布式持久化 | [PostgreSQL](/zh/veadk/components/session/postgresql) |
